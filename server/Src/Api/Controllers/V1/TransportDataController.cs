...
public class TransportDataController : ApiController
{
    ...
    [HttpGet($"stationBoard", Name = $"v1/{nameof(TransportDataController)}/{nameof(GetStationBoard)}")]
    ...
    /// <param name="limit">Result count</param>
    [HttpGet($"locationInformation", Name = $"v1/{nameof(TransportDataController)}/{nameof(GetLocationInformation)}")]
